...
public interface CTShape extends org.apache.xmlbeans.XmlObject {
    DocumentFactory<com.microsoft.schemas.vml.CTShape> Factory = new DocumentFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "ctshape5cb5type");
     ...
     */
    java.util.List<com.microsoft.schemas.office.office.CTInk> getInkList();
     ...
     */
    java.util.List<com.microsoft.schemas.office.powerpoint.CTEmpty> getIscommentList();

    /**
     * Gets array of all "iscomment" elements
     */
    com.microsoft.schemas.office.powerpoint.CTEmpty[] getIscommentArray();

    /**
     * Gets ith "iscomment" element
     */
    com.microsoft.schemas.office.powerpoint.CTEmpty getIscommentArray(int i);
     ...
     */
    void setIscommentArray(com.microsoft.schemas.office.powerpoint.CTEmpty[] iscommentArray);

    /**
     * Sets ith "iscomment" element
     */
    void setIscommentArray(int i, com.microsoft.schemas.office.powerpoint.CTEmpty iscomment);

    /**
     * Inserts and returns a new empty value (as xml) as the ith "iscomment" element
     */
    com.microsoft.schemas.office.powerpoint.CTEmpty insertNewIscomment(int i);
     ...
     */
    java.util.List<com.microsoft.schemas.office.office.CTEquationXml> getEquationxmlList();

    /**
     * Gets array of all "equationxml" elements
     */
    com.microsoft.schemas.office.office.CTEquationXml[] getEquationxmlArray();

    /**
     * Gets ith "equationxml" element
     */
    com.microsoft.schemas.office.office.CTEquationXml getEquationxmlArray(int i);
    ...
    /**
     * Sets array of all "equationxml" element
     */
    void setEquationxmlArray(com.microsoft.schemas.office.office.CTEquationXml[] equationxmlArray);

    /**
     * Sets ith "equationxml" element
     */
    void setEquationxmlArray(int i, com.microsoft.schemas.office.office.CTEquationXml equationxml);

    /**
     * Inserts and returns a new empty value (as xml) as the ith "equationxml" element
     */
    com.microsoft.schemas.office.office.CTEquationXml insertNewEquationxml(int i);
     ...
     */
    java.lang.String getEquationxml2();

    /**
     * Gets (as xml) the "equationxml" attribute
     */
    org.apache.xmlbeans.XmlString xgetEquationxml2();
     ...
     */
    void setEquationxml2(java.lang.String equationxml2);

    /**
     * Sets (as xml) the "equationxml" attribute
     */
    void xsetEquationxml2(org.apache.xmlbeans.XmlString equationxml2);
