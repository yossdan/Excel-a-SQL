...
public interface STHorizontalAnchor extends org.apache.xmlbeans.XmlString {
    SimpleTypeFactory<com.microsoft.schemas.office.word.STHorizontalAnchor> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "sthorizontalanchora13atype");
    ...
    Enum CHAR = Enum.forString("char");

    int INT_MARGIN = Enum.INT_MARGIN;
    int INT_PAGE = Enum.INT_PAGE;
    int INT_TEXT = Enum.INT_TEXT;
    int INT_CHAR = Enum.INT_CHAR;

    /**
     * Enumeration value class for com.microsoft.schemas.office.word.STHorizontalAnchor.
