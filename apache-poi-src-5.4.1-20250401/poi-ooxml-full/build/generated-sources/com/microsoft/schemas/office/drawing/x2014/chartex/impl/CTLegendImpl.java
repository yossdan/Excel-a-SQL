 ...
 * Java type: com.microsoft.schemas.office.drawing.x2014.chartex.CTLegend
 *
...
/**
 * An XML CT_Legend(@http://schemas.microsoft.com/office/drawing/2014/chartex).
 *
 * This is a complex type.
 */
public class CTLegendImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.microsoft.schemas.office.drawing.x2014.chartex.CTLegend {
    ...
    public void setTxPr(org.openxmlformats.schemas.drawingml.x2006.main.CTTextBody txPr) {
        generatedSetterHelperImpl(txPr, PROPERTY_QNAME[1], 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.microsoft.schemas.office.drawing.x2014.chartex.STSidePos xgetPos() {
        synchronized (monitor()) {
            ...
            target = (com.microsoft.schemas.office.drawing.x2014.chartex.STSidePos)get_store().find_attribute_user(PROPERTY_QNAME[3]);
            if (target == null) {
                target = (com.microsoft.schemas.office.drawing.x2014.chartex.STSidePos)get_default_attribute_value(PROPERTY_QNAME[3]);
            }
            return target;
        }
    }
    ...
    public void xsetPos(com.microsoft.schemas.office.drawing.x2014.chartex.STSidePos pos) {
        synchronized (monitor()) {
            ...
            target = (com.microsoft.schemas.office.drawing.x2014.chartex.STSidePos)get_store().find_attribute_user(PROPERTY_QNAME[3]);
            if (target == null) {
                target = (com.microsoft.schemas.office.drawing.x2014.chartex.STSidePos)get_store().add_attribute_user(PROPERTY_QNAME[3]);
            }
            target.set(pos);
        }
    }
    ...
    public com.microsoft.schemas.office.drawing.x2014.chartex.STPosAlign xgetAlign() {
        synchronized (monitor()) {
            ...
            target = (com.microsoft.schemas.office.drawing.x2014.chartex.STPosAlign)get_store().find_attribute_user(PROPERTY_QNAME[4]);
            if (target == null) {
                target = (com.microsoft.schemas.office.drawing.x2014.chartex.STPosAlign)get_default_attribute_value(PROPERTY_QNAME[4]);
            }
            return target;
        }
    }
    ...
    public void xsetAlign(com.microsoft.schemas.office.drawing.x2014.chartex.STPosAlign align) {
        synchronized (monitor()) {
            ...
            target = (com.microsoft.schemas.office.drawing.x2014.chartex.STPosAlign)get_store().find_attribute_user(PROPERTY_QNAME[4]);
            if (target == null) {
                target = (com.microsoft.schemas.office.drawing.x2014.chartex.STPosAlign)get_store().add_attribute_user(PROPERTY_QNAME[4]);
            }
            target.set(align);
        }
    }
