...
public interface STCalloutPlacement extends org.apache.xmlbeans.XmlString {
    SimpleTypeFactory<com.microsoft.schemas.office.office.STCalloutPlacement> Factory = new SimpleTypeFactory<>(org.apache.poi.schemas.ooxml.system.ooxml.TypeSystemHolder.typeSystem, "stcalloutplacementa988type");
    ...
    Enum USER = Enum.forString("user");

    int INT_TOP = Enum.INT_TOP;
    int INT_CENTER = Enum.INT_CENTER;
    int INT_BOTTOM = Enum.INT_BOTTOM;
    int INT_USER = Enum.INT_USER;

    /**
     * Enumeration value class for com.microsoft.schemas.office.office.STCalloutPlacement.
