 ...
 */
public class CTPageSetupImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.microsoft.schemas.office.drawing.x2014.chartex.CTPageSetup {
     ...
     */
    @Override
    public com.microsoft.schemas.office.drawing.x2014.chartex.STPageOrientation.Enum getOrientation() {
        synchronized (monitor()) {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            ...
            return (target == null) ? null : (com.microsoft.schemas.office.drawing.x2014.chartex.STPageOrientation.Enum)target.getEnumValue();
        }
    }
     ...
     */
    @Override
    public com.microsoft.schemas.office.drawing.x2014.chartex.STPageOrientation xgetOrientation() {
        synchronized (monitor()) {
            check_orphaned();
            com.microsoft.schemas.office.drawing.x2014.chartex.STPageOrientation target = null;
            target = (com.microsoft.schemas.office.drawing.x2014.chartex.STPageOrientation)get_store().find_attribute_user(PROPERTY_QNAME[2]);
            if (target == null) {
                target = (com.microsoft.schemas.office.drawing.x2014.chartex.STPageOrientation)get_default_attribute_value(PROPERTY_QNAME[2]);
            }
            return target;
        }
    }
     ...
     */
    @Override
    public void setOrientation(com.microsoft.schemas.office.drawing.x2014.chartex.STPageOrientation.Enum orientation) {
        synchronized (monitor()) {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(PROPERTY_QNAME[2]);
     ...
     */
    @Override
    public void xsetOrientation(com.microsoft.schemas.office.drawing.x2014.chartex.STPageOrientation orientation) {
        synchronized (monitor()) {
            check_orphaned();
            com.microsoft.schemas.office.drawing.x2014.chartex.STPageOrientation target = null;
            target = (com.microsoft.schemas.office.drawing.x2014.chartex.STPageOrientation)get_store().find_attribute_user(PROPERTY_QNAME[2]);
            if (target == null) {
                target = (com.microsoft.schemas.office.drawing.x2014.chartex.STPageOrientation)get_store().add_attribute_user(PROPERTY_QNAME[2]);
            }
