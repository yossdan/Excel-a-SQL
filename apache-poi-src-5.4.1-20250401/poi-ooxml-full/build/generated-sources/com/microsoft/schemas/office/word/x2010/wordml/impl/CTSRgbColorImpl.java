 ...
 * Java type: com.microsoft.schemas.office.word.x2010.wordml.CTSRgbColor
 *
...
/**
 * An XML CT_SRgbColor(@http://schemas.microsoft.com/office/word/2010/wordml).
 *
 * This is a complex type.
 */
public class CTSRgbColorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.microsoft.schemas.office.word.x2010.wordml.CTSRgbColor {
    ...
    public org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STHexColorRGB xgetVal() {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STHexColorRGB)get_store().find_attribute_user(PROPERTY_QNAME[10]);
            return target;
        }
    }
    ...
    public void xsetVal(org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STHexColorRGB val) {
        synchronized (monitor()) {
            ...
            target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STHexColorRGB)get_store().find_attribute_user(PROPERTY_QNAME[10]);
            if (target == null) {
                target = (org.openxmlformats.schemas.officeDocument.x2006.sharedTypes.STHexColorRGB)get_store().add_attribute_user(PROPERTY_QNAME[10]);
            }
            target.set(val);
        }
    }
