 ...
 */
public class CTBevelImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.microsoft.schemas.office.word.x2010.wordml.CTBevel {
    ...
    private static final QName[] PROPERTY_QNAME = {
        ...
        new QName("http://schemas.microsoft.com/office/word/2010/wordml", "h"),
     ...
     */
    @Override
    public com.microsoft.schemas.office.word.x2010.wordml.STBevelPresetType.Enum getPrst() {
        synchronized (monitor()) {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(PROPERTY_QNAME[2]);
            return (target == null) ? null : (com.microsoft.schemas.office.word.x2010.wordml.STBevelPresetType.Enum)target.getEnumValue();
        }
    }
     ...
     */
    @Override
    public com.microsoft.schemas.office.word.x2010.wordml.STBevelPresetType xgetPrst() {
        synchronized (monitor()) {
            check_orphaned();
            com.microsoft.schemas.office.word.x2010.wordml.STBevelPresetType target = null;
            target = (com.microsoft.schemas.office.word.x2010.wordml.STBevelPresetType)get_store().find_attribute_user(PROPERTY_QNAME[2]);
            return target;
        }
    }
     ...
     */
    @Override
    public void setPrst(com.microsoft.schemas.office.word.x2010.wordml.STBevelPresetType.Enum prst) {
        synchronized (monitor()) {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(PROPERTY_QNAME[2]);
     ...
     */
    @Override
    public void xsetPrst(com.microsoft.schemas.office.word.x2010.wordml.STBevelPresetType prst) {
        synchronized (monitor()) {
            check_orphaned();
            com.microsoft.schemas.office.word.x2010.wordml.STBevelPresetType target = null;
            target = (com.microsoft.schemas.office.word.x2010.wordml.STBevelPresetType)get_store().find_attribute_user(PROPERTY_QNAME[2]);
            if (target == null) {
                target = (com.microsoft.schemas.office.word.x2010.wordml.STBevelPresetType)get_store().add_attribute_user(PROPERTY_QNAME[2]);
            }
            target.set(prst);
        }
    }
