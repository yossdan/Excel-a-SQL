 ...
 */
public class CTFilteredAreaSerImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.microsoft.schemas.office.drawing.x2012.chart.CTFilteredAreaSer {
    private static final long serialVersionUID = 1L;

    public CTFilteredAreaSerImpl(org.apache.xmlbeans.SchemaType sType) {
        super(sType);
    }
     ...
     */
    @Override
    public org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaSer getSer() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaSer target = null;
            target = (org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaSer)get_store().find_element_user(PROPERTY_QNAME[0], 0);
     ...
     */
    @Override
    public void setSer(org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaSer ser) {
    ...
    public org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaSer addNewSer() {
        synchronized (monitor()) {
            check_orphaned();
            org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaSer target = null;
            target = (org.openxmlformats.schemas.drawingml.x2006.chart.CTAreaSer)get_store().add_element_user(PROPERTY_QNAME[0]);
            return target;
        }
    }
}
